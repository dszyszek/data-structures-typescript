...
describe('Linked List unit tests', () => {
    ...
    describe('Linked List creation tests', () => {
        ...
        it('should create linked list from array of objects', () => {
            ...
            expect(newLinkedList.getNodeAt(newLinkedList.length-1).val).toEqual(LINKED_LIST_PAYLOAD[LINKED_LIST_PAYLOAD.length-1]);
        });
    });
    ...
    describe('Getters tests', () => {
        ...
        it('should return lastNode', () => {
            const lastElementOfPayloadArray: any[] = LINKED_LIST_PAYLOAD.slice(LINKED_LIST_PAYLOAD.length - 1);
